...
#five layers 1132 borders(92+14)

# noinspection PyPackageRequirements
if __name__ == '__main__':
    net = unet.Unet(layers=5, features_root=64, cost="cross_entropy", channels=3, n_class=2, border_addition=0, summaries=True)
    ...
    data_provider = \
        image_util.ImageDataProvider("Potsdam/resized/train/*.tif", "Potsdam/resized/train/", patch_size=1024,
                                                 channels=3, n_class=2, border_size=net.offset//2, data_suffix=".tif",
    ...
    path = trainer.train(data_provider, eval_data_provider, "summaries/", dropout=0.75,
                            training_iters=20, eval_iters=4, epochs=500, display_step=4,  restore=True)
