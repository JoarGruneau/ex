...
if __name__ == '__main__':
    net = unet.Unet(layers=3, features_root=4, cost="cross_entropy", channels=3, n_class=2, border_addition=6, summaries=True)
    ...
    path = trainer.train(data_provider, eval_data_provider, "summaries/", dropout=0.75,
                            training_iters=20, eval_iters=4, epochs=400, display_step=100, predict_step=100,  restore=False)
