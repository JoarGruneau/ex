...
if __name__ == '__main__':
    net = unet.Unet(layers=5, features_root=64, cost="cross_entropy", channels=3, n_class=2, border_addition=2, summaries=True)
    ...
    path = trainer.train(data_provider, eval_data_provider, "summaries/", dropout=0.75,
                            training_iters=20, eval_iters=4, epochs=400, display_step=20,  restore=False)
