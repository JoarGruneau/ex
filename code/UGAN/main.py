...
if __name__ == '__main__':
    ...
    # print (type(img))
    net = unet.Unet(layers=12, features_root=32, cost="cross_entropy", channels=3, n_class=2, summaries=False)
    ...
    path = trainer.train(data_provider, "train/", dropout=0.75,
                         training_iters=24, epochs=25, display_step=1,  restore=False)
