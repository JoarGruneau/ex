...
if __name__ == '__main__':
    net = unet.Unet(layers=3, features_root=4, cost="IoU", cost_kwargs={"class_weights": [0.7, 99.3]}, channels=3, n_class=2)
    ...
    path = trainer.train(data_provider, "train/", dropout=0.5,
                         training_iters=1271, epochs=25, display_step=1,  restore=False)
